...
public class Tester {
	...
	public static final Rectangle2D BOUNDS = new Rectangle2D.Double(0.001, 0.001, 0.999, 0.999);
	...
	public boolean fitsBounds(ArmConfig cfg) {
		...
		for (Line2D link : links) {
			if (!lenientBounds.contains(link.getP2())) {
                            //System.out.println(2 + " "+ link.getP2() + ""+ link.getP1() + "arm "+ cfg);
				return false;
			}
		}
		List<Line2D> chair = cfg.getChair();
